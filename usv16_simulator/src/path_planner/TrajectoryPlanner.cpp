...
//	mActionSet = lParserObj.parseControlActions("../config/ControlActions.txt");
    mActionSet = lParserObj.parseControlActions("/home/calvin/Documents/theGUI_cws/src/thegui/usv16_simulator/config/ControlActions.txt");
//    mIntermediateActionSet = lParserObj.parseIntermediateControlActions("../config/IntermediateControlActions.txt");
    mIntermediateActionSet = lParserObj.parseIntermediateControlActions("/home/calvin/Documents/theGUI_cws/src/thegui/usv16_simulator/config/IntermediateControlActions.txt");
...
//    mObstaclesCenters = lParserObj.loadObstaclesCenter("../obstacles/ObstaclesCenter.txt");
    mObstaclesCenters = lParserObj.loadObstaclesCenter("/home/calvin/Documents/theGUI_cws/src/thegui/usv16_simulator/config/obstacles/ObstaclesCenter.txt");
	mAllObstacles.clear();
	setStaticObstacles();
