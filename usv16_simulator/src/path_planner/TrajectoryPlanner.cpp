...
//	mActionSet = lParserObj.parseControlActions("../config/ControlActions.txt");
    mActionSet = lParserObj.parseControlActions("/home/tardis/Programming/catkin_sandbox/src/usv16_simulation/usv16_simulator/config/ControlActions.txt");
//    mIntermediateActionSet = lParserObj.parseIntermediateControlActions("../config/IntermediateControlActions.txt");
    mIntermediateActionSet = lParserObj.parseIntermediateControlActions("/home/tardis/Programming/catkin_sandbox/src/usv16_simulation/usv16_simulator/config/IntermediateControlActions.txt");
...
//    mObstaclesCenters = lParserObj.loadObstaclesCenter("../obstacles/ObstaclesCenter.txt");
    mObstaclesCenters = lParserObj.loadObstaclesCenter("/home/tardis/Programming/catkin_sandbox/src/usv16_simulation/usv16_simulator/config/obstacles/ObstaclesCenter.txt");
	mAllObstacles.clear();
	setStaticObstacles();
