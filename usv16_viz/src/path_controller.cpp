...
usv16_viz::control msg_actuation;

// the path controller
Ship vehicle = Ship();
HeadingController controller = HeadingController(vehicle, 0.75, 25, 10, 2.5);

void callback_pose(const usv16_viz::pose &msg_pose)
{
...
void callback_course(const usv16_viz::course &msg_course)
{
...
int main(int argc, char **argv) {
    ...
    pubPtr_control = new ros::Publisher(nh.advertise<usv16_viz::control>("ship/actuation", 1000));
